...
def get_dataloaders(input_paths, target_paths, batch_size, val_batch_size='None', val_img='None', val_target='None', test_img='None', test_target='None', img_size='None', test_remove='None', types='None', num_classes=1, workers_num='None', include_backg=True):
